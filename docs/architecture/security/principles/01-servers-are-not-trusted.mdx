...
encrypted content, but we do this to aggregate access to the requested domain, speed up loading of
vaults, and ensure favicons accurately represent the associated URI. This feature is easily disabled
in client settings.
