...
As illustrated in the example above, any messages that need to be relayed from the `InlineMenuListPage`
to the `InlineMenuBackground` script must pass through the `AutofillInlineMenuIframe` content script. This
