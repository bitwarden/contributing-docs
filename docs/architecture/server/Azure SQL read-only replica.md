...
- The HA replica is not a backup and should not be treated as such. If a destructive migration had been run on the primary the primary instance it will be reflucted on the HA replica. DR prodedures will have to be carried out in this scenario and there will be data loss. 
