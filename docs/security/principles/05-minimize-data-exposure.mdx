# P5: Minimized impact of security breaches
...
should take any available action to help users limit the damage caused by such breaches, both in
scope and duration. This involves:
