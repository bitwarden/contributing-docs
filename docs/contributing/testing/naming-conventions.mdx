...
This section currently only covers client tests written in Typescript. It is, in its current form,
not intended to be used for server tests written in C#, even if the underlying philosphy might still
be applicable.
