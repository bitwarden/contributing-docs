...
2.  The above command will need to be ran each time you restart your computer. If you would like to
    automate this process, then you can leverage LaunchAgents to run the command on startup.
