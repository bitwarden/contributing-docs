...
7.  Open the mobile solution file (`bitwarden-mobile.sln`) in the root of your local mobile
    repository. You should now be able to run the app by setting
...
your version of Xamarin may not yet support the version of Xcode that you are using (as discussed
...
use from the Xamarin.iOS [release notes](https://github.com/xamarin/xamarin-macios/releases). After
installing the new version of Xcode, restart Visual Studio and load your project to verify your
