...
In certain environments such as WSL, it might be necessary to cross-compile the native module. To do
this install the relevant rust target with `rustup` see
[this article](https://rust-lang.github.io/rustup/cross-compilation.html) for more information.
