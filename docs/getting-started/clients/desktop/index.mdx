...
2. Download the corresponding `.nsis` file (also seen in figure below)
3. Place the `.nsis` file in the same directory as the installer (this might require decompressing
   the download)
