...
1.  Build and run the Web Vault.
  ...
  :::info
    ...
    If working on billing or more advanced organization settings, you may need to build the client with `npm run build:bit:watch` to access the correct views and functionality.
