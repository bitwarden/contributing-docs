...
To protect against commit spoofing, all Bitwarden developers must digitally sign their commits. This
is optional but encouraged for community contributors.
